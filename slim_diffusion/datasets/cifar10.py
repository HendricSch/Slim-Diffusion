...
class CIFAR10:
    """
    Diese Klasse bildet einen Wrapper um das CIFAR-10 Dataset. Sie stellt die Funktionen zur Verfügung, die für das
    ...
    def __init__(self, img_size=32):
        ...
        # Lädt den CIFAR-10 Trainingsdatensatz herunter.
        ...
        # Lädt den CIFAR-10 Testdatensatz herunter.
    ...
    def get_dataloader(self, batch_size=64, shuffle=True):
        """
        Erstellt einen DataLoader für den CIFAR-10 Datensatz.
        """
        return DataLoader(
            self.data,
